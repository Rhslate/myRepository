...
function add() {
    ...
    var todos = get_todos();
    /*This adds a new tasl the end of the array*/
    todos.push(task);
...
/*This displays the inputed tasl when the 'Add Item' button is clicked*/
...
function remove() {
    ...
    todos.splice(id, 1);
    localStorage.setItem('todo', JSON.stringify(todos));
    /*this looks in the show () to display a removed item on the screen*/
    show();
